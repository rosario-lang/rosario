...
We all like some features (and lack of features) in programming languages. Some will like garbage collectors, others will like manual memory management, others will like the borrow checker, and so on... But those can become a problem when you're trying to finish a product, and the your so beloved features start getting in the way:
